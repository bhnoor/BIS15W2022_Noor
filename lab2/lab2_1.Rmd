...
#What I interpreted from this result is that the NA is a result of missing data from part 1. 

4. Recalculate the mean using the following code chunk. Why is the useful?
It is useful because it allows one to choose which data to use and get rid of the NA. 
```{r}
